                        ...
                        <div class="grid md:grid-cols-2">
                            <div class="leftCardAnimation h-full pr-6">
                                ...
                                <ul class="mb-6 md:mb-0">
                                    <li class="flex">
                                        <div class="backgroundcolor-yellow flex h-10 w-10 items-center justify-center rounded  text-gray-50">
                                    ...
                                    <li class="flex">
                                        ...
                                        <div class="ml-4 mb-4">
                                            ...
                                            <p class="text-gray-600 dark:text-slate-400">Mobile: +1 (737) 295-1375</p>
