        ...
        <div  className='py-4' >
          ...
          <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
            ...
            <div  style={{"boxShadow" : "rgba(0, 0, 0, 0.35) 0px 5px 15px"}}   className="h-full Eleveted-from-bottom">                                
              <div className="relative flex flex-col h-full p-6  bg-white   border border-slate-200   ">
                <div className="mb-5">
                  <div className="text-slate-900   font-semibold mb-1">Personal</div>
                  {/* <div className="inline-flex items-baseline mb-2">
                    <span className="text-slate-900   font-bold text-3xl">$100</span>
                    <span className="text-slate-900   font-bold text-4xl" x-text={isAnnual ? '29' : '35'}></span>
            ...
            <div  style={{"boxShadow" : "rgba(0, 0, 0, 0.35) 0px 5px 15px"}}   class="h-full Eleveted-from-bottom">
                        <div class="relative flex flex-col h-full p-6  bg-white   border border-slate-200   ">
                            ...
                            <div class="mb-5">
                                <div class="text-slate-900   font-semibold mb-1">Professional</div>
                                <div class="inline-flex items-baseline mb-2">
                                    <span class="text-slate-900   font-bold text-3xl">$200</span>
            ...
            <div  style={{"boxShadow" : "rgba(0, 0, 0, 0.35) 0px 5px 15px"}}   class="h-full Eleveted-from-bottom">
                        <div class="relative flex flex-col h-full p-6  bg-white   border border-slate-200   ">
                            <div class="mb-5">
                                <div class="text-slate-900   font-semibold mb-1">Enterprise</div>
                                <div class="inline-flex items-baseline mb-2">
                                    <span class="text-slate-900   font-bold text-3xl">$300</span>
                                    <span class="text-slate-900   font-bold text-4xl" x-text="isAnnual ? '79' : '85'"></span>
                                    <span class="text-slate-500 font-medium">/mo</span>
                                </div>
                                <div class="text-sm text-slate-500 mb-5">There are many variations available, but the majority have suffered.</div>
                                <a  style={{  backgroundImage: "linear-gradient(180deg, rgba(250, 152, 0, 1) 0%, rgba(223, 123, 1, 1) 100%)"}}   class="w-full inline-flex justify-center whitespace-nowrap rounded-lg  px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:bg-indigo-600 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 " href="#0">
